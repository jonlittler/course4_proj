...
class Dev(Configuration):
    ...
    # This prevents manage.py from running unless the DJANGO_OMDB_KEY 
    # value is present as an environment variable. So, you would 
    # either need to export this variable first.
